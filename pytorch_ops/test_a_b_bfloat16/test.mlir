module @module {
  func.func @main(%arg0: !torch.vtensor<[?,64],f32>, %arg1: !torch.vtensor<[64,?],f32>) -> !torch.vtensor<[?,?],f32> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %3 = torch.prims.convert_element_type %2, %int6_9 : !torch.vtensor<[?,?],bf16>, !torch.int -> !torch.vtensor<[?,?],f32>
    ...
    torch.aten._assert_tensor_metadata %2, %none_10, %none_11, %int15_12, %none_13, %none_14 : !torch.vtensor<[?,?],bf16>, !torch.none, !torch.none, !torch.int, !torch.none, !torch.none

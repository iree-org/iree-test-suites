...
def main():
    ...
    parser.add_argument("--dtype", default="fp8", help="Data type (fp16/fp8/mistral_fp8)")
    parser.add_argument("--attention-kernel", default="sharktank", help="Which Attention Kernel To Use")
    parser.add_argument("--device-block-count", default="8043", help="What Device Block Count To Be Used")
    parser.add_argument(
    ...
    export_cmd = [
        ...
        f"--output-mlir={os.path.join(output_dir, 'model.mlir')}",

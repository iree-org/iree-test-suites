...
module {
  ...
  func.func private @conv_3d_bfloat16_forward_b_16x8x48x32x288_ndhwc_288x1x3x3x96_fdhwc_ndhwf_1x1x1s_0x1x1p_1x1x1d_3g(%arg0: tensor<16x8x48x32x288xbf16>, %arg1: tensor<288x1x3x3x96xbf16>, %arg2: tensor<288xbf16>) -> tensor<16x8x48x32x288xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %3 = torch.prim.ListConstruct %int16, %int8, %int48, %int32, %int3, %int96 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %4 = torch.aten.view %2, %3 : !torch.vtensor<[16,8,48,32,288],bf16>, !torch.list<int> -> !torch.vtensor<[16,8,48,32,3,96],bf16>
    %5 = torch.prim.ListConstruct %int3, %int96, %int1, %int3, %int3, %int96 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %6 = torch.aten.view %1, %5 : !torch.vtensor<[288,1,3,3,96],bf16>, !torch.list<int> -> !torch.vtensor<[3,96,1,3,3,96],bf16>
    ...
    %13 = torch.aten._to_copy %12, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[16,8,48,32,3,96],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[16,8,48,32,3,96],bf16>
    %14 = torch.prim.ListConstruct %int16, %int8, %int48, %int32, %int288 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %15 = torch.aten.view %13, %14 : !torch.vtensor<[16,8,48,32,3,96],bf16>, !torch.list<int> -> !torch.vtensor<[16,8,48,32,288],bf16>
    %16 = torch.aten.add.Tensor %15, %0, %int1 : !torch.vtensor<[16,8,48,32,288],bf16>, !torch.vtensor<[288],bf16>, !torch.int -> !torch.vtensor<[16,8,48,32,288],bf16>
    %17 = torch_c.to_builtin_tensor %16 : !torch.vtensor<[16,8,48,32,288],bf16> -> tensor<16x8x48x32x288xbf16>
    return %17 : tensor<16x8x48x32x288xbf16>
  }

...
module {
  ...
  func.func private @conv_3d_bfloat16_forward_16x8x48x32x288_ndhwc_288x1x3x3x96_fdhwc_ndhwf_1x1x1s_0x1x1p_1x1x1d_3g(%arg0: tensor<16x8x48x32x288xbf16>, %arg1: tensor<288x1x3x3x96xbf16>) -> tensor<16x8x48x32x288xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %12 = torch.aten._to_copy %11, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[16,8,48,32,3,96],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[16,8,48,32,3,96],bf16>
    %13 = torch.prim.ListConstruct %int16, %int8, %int48, %int32, %int288 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %14 = torch.aten.view %12, %13 : !torch.vtensor<[16,8,48,32,3,96],bf16>, !torch.list<int> -> !torch.vtensor<[16,8,48,32,288],bf16>
    %15 = torch_c.to_builtin_tensor %14 : !torch.vtensor<[16,8,48,32,288],bf16> -> tensor<16x8x48x32x288xbf16>
    return %15 : tensor<16x8x48x32x288xbf16>
  }

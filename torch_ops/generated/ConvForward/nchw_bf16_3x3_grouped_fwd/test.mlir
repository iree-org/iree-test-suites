...
module {
  ...
  func.func private @conv_2d_bfloat16_forward_128x384x48x32_nchw_384x64x3x3_fchw_nfhw_1x1s_1x1p_1x1d_6g(%arg0: tensor<128x384x48x32xbf16>, %arg1: tensor<384x64x3x3xbf16>) -> tensor<128x384x48x32xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %2 = torch.prim.ListConstruct %int128, %int6, %int64, %int48, %int32 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %3 = torch.aten.view %1, %2 : !torch.vtensor<[128,384,48,32],bf16>, !torch.list<int> -> !torch.vtensor<[128,6,64,48,32],bf16>
    %4 = torch.prim.ListConstruct %int6, %int64, %int64, %int3, %int3 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %5 = torch.aten.view %0, %4 : !torch.vtensor<[384,64,3,3],bf16>, !torch.list<int> -> !torch.vtensor<[6,64,64,3,3],bf16>
    ...
    %12 = torch.aten._to_copy %11, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[128,6,64,48,32],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[128,6,64,48,32],bf16>
    %13 = torch.prim.ListConstruct %int128, %int384, %int48, %int32 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %14 = torch.aten.view %12, %13 : !torch.vtensor<[128,6,64,48,32],bf16>, !torch.list<int> -> !torch.vtensor<[128,384,48,32],bf16>
    %15 = torch_c.to_builtin_tensor %14 : !torch.vtensor<[128,384,48,32],bf16> -> tensor<128x384x48x32xbf16>
    return %15 : tensor<128x384x48x32xbf16>
  }

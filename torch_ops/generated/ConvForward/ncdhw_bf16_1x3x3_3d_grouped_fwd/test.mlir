...
module {
  func.func public @fused_op_layout_cus_a951aca650fb6f40ab63e062019ef14b9f0e8887_16x288x8x48x32xbfloat16_288x96x1x3x3xbfloat16(%arg0: !torch.vtensor<[16,288,8,48,32],bf16>, %arg1: !torch.vtensor<[288,96,1,3,3],bf16>) -> !torch.vtensor<[16,288,8,48,32],bf16> {
    ...
    %2 = call @conv_3d_bfloat16_forward_16x288x8x48x32_ncdhw_288x96x1x3x3_fcdhw_nfdhw_1x1x1s_0x1x1p_1x1x1d_3g(%0, %1) : (tensor<16x288x8x48x32xbf16>, tensor<288x96x1x3x3xbf16>) -> tensor<16x288x8x48x32xbf16>
    %3 = torch_c.from_builtin_tensor %2 : tensor<16x288x8x48x32xbf16> -> !torch.vtensor<[16,288,8,48,32],bf16>
    return %3 : !torch.vtensor<[16,288,8,48,32],bf16>
  }
  func.func private @conv_3d_bfloat16_forward_16x288x8x48x32_ncdhw_288x96x1x3x3_fcdhw_nfdhw_1x1x1s_0x1x1p_1x1x1d_3g(%arg0: tensor<16x288x8x48x32xbf16>, %arg1: tensor<288x96x1x3x3xbf16>) -> tensor<16x288x8x48x32xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    %0 = torch_c.from_builtin_tensor %arg1 : tensor<288x96x1x3x3xbf16> -> !torch.vtensor<[288,96,1,3,3],bf16>
    ...
    %9 = torch_c.to_builtin_tensor %5 : !torch.vtensor<[3,96,96,1,3,3],bf16> -> tensor<3x96x96x1x3x3xbf16>
    %10 = util.call @generic_conv_16x3x96x8x50x34xbf16_3x96x96x1x3x3xbf16_1x1x1S_1x1x1D_ngcdhw_gfcdhw_ngfdhw_f32(%8, %9) : (tensor<16x3x96x8x50x34xbf16>, tensor<3x96x96x1x3x3xbf16>) -> tensor<16x3x96x8x48x32xf32>
    %11 = torch_c.from_builtin_tensor %10 : tensor<16x3x96x8x48x32xf32> -> !torch.vtensor<[16,3,96,8,48,32],f32>
    %12 = torch.aten._to_copy %11, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[16,3,96,8,48,32],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[16,3,96,8,48,32],bf16>
    %13 = torch.prim.ListConstruct %int16, %int288, %int8, %int48, %int32 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %14 = torch.aten.view %12, %13 : !torch.vtensor<[16,3,96,8,48,32],bf16>, !torch.list<int> -> !torch.vtensor<[16,288,8,48,32],bf16>
    %15 = torch_c.to_builtin_tensor %14 : !torch.vtensor<[16,288,8,48,32],bf16> -> tensor<16x288x8x48x32xbf16>
    return %15 : tensor<16x288x8x48x32xbf16>
  }

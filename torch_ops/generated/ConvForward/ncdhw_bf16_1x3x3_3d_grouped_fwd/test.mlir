...
module {
  ...
  func.func private @conv_3d_bfloat16_forward_16x288x8x48x32_ncdhw_288x96x1x3x3_fcdhw_nfdhw_1x1x1s_0x1x1p_1x1x1d_3g(%arg0: tensor<16x288x8x48x32xbf16>, %arg1: tensor<288x96x1x3x3xbf16>) -> tensor<16x288x8x48x32xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %12 = torch.aten.to.dtype %11, %int15, %false, %false, %none : !torch.vtensor<[16,3,96,8,48,32],f32>, !torch.int, !torch.bool, !torch.bool, !torch.none -> !torch.vtensor<[16,3,96,8,48,32],bf16>
    %13 = torch.aten.flatten.using_ints %12, %int1, %int2 : !torch.vtensor<[16,3,96,8,48,32],bf16>, !torch.int, !torch.int -> !torch.vtensor<[16,288,8,48,32],bf16>
    %14 = torch_c.to_builtin_tensor %13 : !torch.vtensor<[16,288,8,48,32],bf16> -> tensor<16x288x8x48x32xbf16>
    return %14 : tensor<16x288x8x48x32xbf16>
  }

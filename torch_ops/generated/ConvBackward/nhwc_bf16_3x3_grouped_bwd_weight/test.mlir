...
module {
  ...
  func.func private @conv_2d_bfloat16_weight_backward_128x48x32x384_nhwc_384x3x3x64_fhwc_nhwf_1x1s_1x1p_1x1d_6g(%arg0: tensor<128x48x32x384xbf16>, %arg1: tensor<128x48x32x384xbf16>, %arg2: tensor<384x3x3x64xbf16>) -> tensor<384x3x3x64xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %3 = torch.aten.unflatten.int %0, %int3, %2 : !torch.vtensor<[128,48,32,384],bf16>, !torch.int, !torch.list<int> -> !torch.vtensor<[128,48,32,6,64],bf16>
    %4 = torch.prim.ListConstruct %int6, %int-1 : (!torch.int, !torch.int) -> !torch.list<int>
    %5 = torch.aten.unflatten.int %1, %int3, %4 : !torch.vtensor<[128,48,32,384],bf16>, !torch.int, !torch.list<int> -> !torch.vtensor<[128,48,32,6,64],bf16>
    ...
    %12 = torch.aten.to.dtype %11, %int15, %false, %false, %none : !torch.vtensor<[6,64,3,3,64],f32>, !torch.int, !torch.bool, !torch.bool, !torch.none -> !torch.vtensor<[6,64,3,3,64],bf16>
    %13 = torch.aten.flatten.using_ints %12, %int0, %int1 : !torch.vtensor<[6,64,3,3,64],bf16>, !torch.int, !torch.int -> !torch.vtensor<[384,3,3,64],bf16>
    %14 = torch_c.to_builtin_tensor %13 : !torch.vtensor<[384,3,3,64],bf16> -> tensor<384x3x3x64xbf16>
    return %14 : tensor<384x3x3x64xbf16>
  }

...
module {
  ...
  func.func private @conv_2d_bfloat16_input_backward_128x48x32x384_nhwc_384x3x3x64_fhwc_nhwf_1x1s_1x1p_1x1d_6g(%arg0: tensor<128x48x32x384xbf16>, %arg1: tensor<128x48x32x384xbf16>, %arg2: tensor<384x3x3x64xbf16>) -> tensor<128x48x32x384xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %3 = torch.aten.view %1, %2 : !torch.vtensor<[128,48,32,384],bf16>, !torch.list<int> -> !torch.vtensor<[128,48,32,6,64],bf16>
    %4 = torch.prim.ListConstruct %int6, %int64, %int3, %int3, %int64 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %5 = torch.aten.view %0, %4 : !torch.vtensor<[384,3,3,64],bf16>, !torch.list<int> -> !torch.vtensor<[6,64,3,3,64],bf16>
    ...
    %14 = torch.aten._to_copy %13, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[128,48,32,6,64],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[128,48,32,6,64],bf16>
    %15 = torch.prim.ListConstruct %int128, %int48, %int32, %int384 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %16 = torch.aten.view %14, %15 : !torch.vtensor<[128,48,32,6,64],bf16>, !torch.list<int> -> !torch.vtensor<[128,48,32,384],bf16>
    %17 = torch_c.to_builtin_tensor %16 : !torch.vtensor<[128,48,32,384],bf16> -> tensor<128x48x32x384xbf16>
    return %17 : tensor<128x48x32x384xbf16>
  }

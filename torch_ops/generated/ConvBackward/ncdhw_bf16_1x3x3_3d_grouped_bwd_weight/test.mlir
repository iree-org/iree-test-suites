...
module {
  ...
  func.func private @conv_3d_bfloat16_weight_backward_16x288x8x48x32_ncdhw_288x96x1x3x3_fcdhw_nfdhw_1x1x1s_0x1x1p_1x1x1d_3g(%arg0: tensor<16x288x8x48x32xbf16>, %arg1: tensor<16x288x8x48x32xbf16>, %arg2: tensor<288x96x1x3x3xbf16>) -> tensor<288x96x1x3x3xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %3 = torch.aten.view %0, %2 : !torch.vtensor<[16,288,8,48,32],bf16>, !torch.list<int> -> !torch.vtensor<[16,3,96,8,48,32],bf16>
    %4 = torch.prim.ListConstruct %int16, %int3, %int96, %int8, %int48, %int32 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %5 = torch.aten.view %1, %4 : !torch.vtensor<[16,288,8,48,32],bf16>, !torch.list<int> -> !torch.vtensor<[16,3,96,8,48,32],bf16>
    ...
    %12 = torch.aten._to_copy %11, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[3,96,96,1,3,3],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[3,96,96,1,3,3],bf16>
    %13 = torch.prim.ListConstruct %int288, %int96, %int1, %int3, %int3 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %14 = torch.aten.view %12, %13 : !torch.vtensor<[3,96,96,1,3,3],bf16>, !torch.list<int> -> !torch.vtensor<[288,96,1,3,3],bf16>
    %15 = torch_c.to_builtin_tensor %14 : !torch.vtensor<[288,96,1,3,3],bf16> -> tensor<288x96x1x3x3xbf16>
    return %15 : tensor<288x96x1x3x3xbf16>
  }

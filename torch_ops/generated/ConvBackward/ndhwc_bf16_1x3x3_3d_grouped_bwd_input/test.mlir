...
module {
  ...
  func.func private @conv_3d_bfloat16_input_backward_16x8x48x32x288_ndhwc_288x1x3x3x96_fdhwc_ndhwf_1x1x1s_0x1x1p_1x1x1d_3g(%arg0: tensor<16x8x48x32x288xbf16>, %arg1: tensor<16x8x48x32x288xbf16>, %arg2: tensor<288x1x3x3x96xbf16>) -> tensor<16x8x48x32x288xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %2 = torch.prim.ListConstruct %int16, %int8, %int48, %int32, %int3, %int96 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %3 = torch.aten.view %1, %2 : !torch.vtensor<[16,8,48,32,288],bf16>, !torch.list<int> -> !torch.vtensor<[16,8,48,32,3,96],bf16>
    %4 = torch.prim.ListConstruct %int3, %int96, %int1, %int3, %int3, %int96 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %5 = torch.aten.view %0, %4 : !torch.vtensor<[288,1,3,3,96],bf16>, !torch.list<int> -> !torch.vtensor<[3,96,1,3,3,96],bf16>
    ...
    %14 = torch.aten._to_copy %13, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[16,8,48,32,3,96],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[16,8,48,32,3,96],bf16>
    %15 = torch.prim.ListConstruct %int16, %int8, %int48, %int32, %int288 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %16 = torch.aten.view %14, %15 : !torch.vtensor<[16,8,48,32,3,96],bf16>, !torch.list<int> -> !torch.vtensor<[16,8,48,32,288],bf16>

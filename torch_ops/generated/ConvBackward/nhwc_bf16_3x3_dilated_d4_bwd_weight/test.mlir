#map = affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d4, d1 * 4 + d5, d2 * 4 + d6, d3)>
#map1 = affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d4, d5, d6, d0)>
#map2 = affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>
module {
  func.func public @fused_op_layout_cus_17890d405f5f2929b76bcca427f3cc5ccd9034a5_16x48x32x48xbfloat16_16x48x32x48xbfloat16_48x3x3x48xbfloat16(%arg0: !torch.vtensor<[16,48,32,48],bf16>, %arg1: !torch.vtensor<[16,48,32,48],bf16>, %arg2: !torch.vtensor<[48,3,3,48],bf16>) -> !torch.vtensor<[48,3,3,48],bf16> {
    ...
    %15 = call @conv_2d_bfloat16_weight_backward_16x48x32x48_nhwc_48x3x3x48_fhwc_nhwf_1x1s_4x4p_4x4d_1g(%12, %13, %14) : (tensor<16x48x32x48xbf16>, tensor<16x48x32x48xbf16>, tensor<48x3x3x48xbf16>) -> tensor<48x3x3x48xbf16>
    %16 = torch_c.from_builtin_tensor %15 : tensor<48x3x3x48xbf16> -> !torch.vtensor<[48,3,3,48],bf16>
    ...
    %18 = torch.aten.permute %16, %17 : !torch.vtensor<[48,3,3,48],bf16>, !torch.list<int> -> !torch.vtensor<[48,48,3,3],bf16>
    ...
    %20 = torch.aten.permute %18, %19 : !torch.vtensor<[48,48,3,3],bf16>, !torch.list<int> -> !torch.vtensor<[48,3,3,48],bf16>
    return %20 : !torch.vtensor<[48,3,3,48],bf16>
  }
  func.func private @conv_2d_bfloat16_weight_backward_16x48x32x48_nhwc_48x3x3x48_fhwc_nhwf_1x1s_4x4p_4x4d_1g(%arg0: tensor<16x48x32x48xbf16>, %arg1: tensor<16x48x32x48xbf16>, %arg2: tensor<48x3x3x48xbf16>) -> tensor<48x3x3x48xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    %0 = torch_c.from_builtin_tensor %arg1 : tensor<16x48x32x48xbf16> -> !torch.vtensor<[16,48,32,48],bf16>
    ...
    %3 = torch.aten.constant_pad_nd %0, %2, %int0 : !torch.vtensor<[16,48,32,48],bf16>, !torch.list<int>, !torch.int -> !torch.vtensor<[16,56,40,48],bf16>
    %4 = torch_c.to_builtin_tensor %3 : !torch.vtensor<[16,56,40,48],bf16> -> tensor<16x56x40x48xbf16>
    %5 = torch_c.to_builtin_tensor %1 : !torch.vtensor<[16,48,32,48],bf16> -> tensor<16x48x32x48xbf16>
    %6 = util.call @generic_conv_16x56x40x48xbf16_16x48x32x48xbf16_4x4S_1x1D_chwn_chwf_fhwn_f32(%4, %5) : (tensor<16x56x40x48xbf16>, tensor<16x48x32x48xbf16>) -> tensor<48x3x3x48xf32>
    %7 = torch_c.from_builtin_tensor %6 : tensor<48x3x3x48xf32> -> !torch.vtensor<[48,3,3,48],f32>
    %8 = torch.aten._to_copy %7, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[48,3,3,48],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[48,3,3,48],bf16>
    %9 = torch_c.to_builtin_tensor %8 : !torch.vtensor<[48,3,3,48],bf16> -> tensor<48x3x3x48xbf16>
    return %9 : tensor<48x3x3x48xbf16>
  }
  util.func private @generic_conv_16x56x40x48xbf16_16x48x32x48xbf16_4x4S_1x1D_chwn_chwf_fhwn_f32(%arg0: tensor<16x56x40x48xbf16>, %arg1: tensor<16x48x32x48xbf16>) -> tensor<48x3x3x48xf32> {
    %cst = arith.constant 0.000000e+00 : f32
    %0 = tensor.empty() : tensor<48x3x3x48xf32>
    %1 = linalg.fill ins(%cst : f32) outs(%0 : tensor<48x3x3x48xf32>) -> tensor<48x3x3x48xf32>
    %2 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg0, %arg1 : tensor<16x56x40x48xbf16>, tensor<16x48x32x48xbf16>) outs(%1 : tensor<48x3x3x48xf32>) {
    ^bb0(%in: bf16, %in_0: bf16, %out: f32):
      ...
      linalg.yield %6 : f32
    } -> tensor<48x3x3x48xf32>
    util.return %2 : tensor<48x3x3x48xf32>
  }
}

...
module {
  ...
  func.func private @conv_2d_bfloat16_input_backward_128x384x48x32_nchw_384x64x3x3_fchw_nfhw_1x1s_1x1p_1x1d_6g(%arg0: tensor<128x384x48x32xbf16>, %arg1: tensor<128x384x48x32xbf16>, %arg2: tensor<384x64x3x3xbf16>) -> tensor<128x384x48x32xbf16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %14 = torch.aten._to_copy %13, %int15, %none, %none, %none, %false, %none : !torch.vtensor<[128,6,64,48,32],f32>, !torch.int, !torch.none, !torch.none, !torch.none, !torch.bool, !torch.none -> !torch.vtensor<[128,6,64,48,32],bf16>
    %15 = torch.prim.ListConstruct %int128, %int384, %int48, %int32 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %16 = torch.aten.view %14, %15 : !torch.vtensor<[128,6,64,48,32],bf16>, !torch.list<int> -> !torch.vtensor<[128,384,48,32],bf16>
    %17 = torch_c.to_builtin_tensor %16 : !torch.vtensor<[128,384,48,32],bf16> -> tensor<128x384x48x32xbf16>
    return %17 : tensor<128x384x48x32xbf16>
  }

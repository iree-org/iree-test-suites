module @module {
  func.func @main(%arg0: !torch.vtensor<[1152,997],f16>, %arg1: !torch.vtensor<[997,576],f16>, %arg2: !torch.vtensor<[1152,576],f16>, %arg3: !torch.tensor<[1152,576],f16>) -> !torch.vtensor<[1152,576],f16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %1 = torch.aten.mm %arg0, %arg1 : !torch.vtensor<[1152,997],f16>, !torch.vtensor<[997,576],f16> -> !torch.vtensor<[1152,576],f16>

...
func.func @matmul_512x128xf8E4M3FNUZ_times_512x128xf8E4M3FNUZ_into_512x512xf32(%lhs: tensor<512x128xf32>, %rhs: tensor<512x128xf32>) -> tensor<512x512xf32> {
  ...
  %lhs_casted = arith.truncf %lhs: tensor<512x128xf32> to tensor<512x128xf8E4M3FNUZ>
  %rhs_casted = arith.truncf %rhs: tensor<512x128xf32> to tensor<512x128xf8E4M3FNUZ>
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<512x128xf8E4M3FNUZ>, tensor<512x128xf8E4M3FNUZ>) outs(%acc: tensor<512x512xf32>) -> tensor<512x512xf32>  return %result: tensor<512x512xf32>
}
...
func.func @matmul_1000x4xf8E4M3FNUZ_times_512x4xf8E4M3FNUZ_into_1000x512xf32(%lhs: tensor<1000x4xf32>, %rhs: tensor<512x4xf32>) -> tensor<1000x512xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<1000x4xf8E4M3FNUZ>, tensor<512x4xf8E4M3FNUZ>) outs(%acc: tensor<1000x512xf32>) -> tensor<1000x512xf32>  return %result: tensor<1000x512xf32>
}
...
func.func @matmul_4x1000xf8E4M3FNUZ_times_512x1000xf8E4M3FNUZ_into_4x512xf32(%lhs: tensor<4x1000xf32>, %rhs: tensor<512x1000xf32>) -> tensor<4x512xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<4x1000xf8E4M3FNUZ>, tensor<512x1000xf8E4M3FNUZ>) outs(%acc: tensor<4x512xf32>) -> tensor<4x512xf32>  return %result: tensor<4x512xf32>
}
...
func.func @matmul_512x1000xf8E4M3FNUZ_times_4x1000xf8E4M3FNUZ_into_512x4xf32(%lhs: tensor<512x1000xf32>, %rhs: tensor<4x1000xf32>) -> tensor<512x4xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<512x1000xf8E4M3FNUZ>, tensor<4x1000xf8E4M3FNUZ>) outs(%acc: tensor<512x4xf32>) -> tensor<512x4xf32>  return %result: tensor<512x4xf32>
}
...
func.func @matmul_512x128xf8E4M3FNUZ_times_500x128xf8E4M3FNUZ_into_512x500xf32(%lhs: tensor<512x128xf32>, %rhs: tensor<500x128xf32>) -> tensor<512x500xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<512x128xf8E4M3FNUZ>, tensor<500x128xf8E4M3FNUZ>) outs(%acc: tensor<512x500xf32>) -> tensor<512x500xf32>  return %result: tensor<512x500xf32>
}

func.func @matmul_accumulate_123x456xf8E4M3FNUZ_times_789x456xf8E4M3FNUZ_into_123x789xf32(%lhs: tensor<123x456xf32>, %rhs: tensor<789x456xf32>, %acc: tensor<123x789xf32>) -> tensor<123x789xf32> {
  %lhs_casted = arith.truncf %lhs: tensor<123x456xf32> to tensor<123x456xf8E4M3FNUZ>
  %rhs_casted = arith.truncf %rhs: tensor<789x456xf32> to tensor<789x456xf8E4M3FNUZ>
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<123x456xf8E4M3FNUZ>, tensor<789x456xf8E4M3FNUZ>) outs(%acc: tensor<123x789xf32>) -> tensor<123x789xf32>
...
func.func @matmul_457x330xf8E4M3FNUZ_times_512x330xf8E4M3FNUZ_into_457x512xf32(%lhs: tensor<457x330xf32>, %rhs: tensor<512x330xf32>) -> tensor<457x512xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<457x330xf8E4M3FNUZ>, tensor<512x330xf8E4M3FNUZ>) outs(%acc: tensor<457x512xf32>) -> tensor<457x512xf32>  return %result: tensor<457x512xf32>
}
...
func.func @matmul_457x330xf8E4M3FNUZ_times_514x330xf8E4M3FNUZ_into_457x514xf32(%lhs: tensor<457x330xf32>, %rhs: tensor<514x330xf32>) -> tensor<457x514xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<457x330xf8E4M3FNUZ>, tensor<514x330xf8E4M3FNUZ>) outs(%acc: tensor<457x514xf32>) -> tensor<457x514xf32>  return %result: tensor<457x514xf32>
}
...
func.func @matmul_438x330xf8E4M3FNUZ_times_514x330xf8E4M3FNUZ_into_438x514xf32(%lhs: tensor<438x330xf32>, %rhs: tensor<514x330xf32>) -> tensor<438x514xf32> {
  ...
  %rhs_casted = arith.truncf %rhs: tensor<514x330xf32> to tensor<514x330xf8E4M3FNUZ>
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<438x330xf8E4M3FNUZ>, tensor<514x330xf8E4M3FNUZ>) outs(%acc: tensor<438x514xf32>) -> tensor<438x514xf32>  return %result: tensor<438x514xf32>
}
...
func.func @matmul_540x332xf8E4M3FNUZ_times_516x332xf8E4M3FNUZ_into_540x516xf32(%lhs: tensor<540x332xf32>, %rhs: tensor<516x332xf32>) -> tensor<540x516xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<540x332xf8E4M3FNUZ>, tensor<516x332xf8E4M3FNUZ>) outs(%acc: tensor<540x516xf32>) -> tensor<540x516xf32>  return %result: tensor<540x516xf32>
}
...
func.func @matmul_654x321xf8E4M3FNUZ_times_234x321xf8E4M3FNUZ_into_654x234xf32(%lhs: tensor<654x321xf32>, %rhs: tensor<234x321xf32>) -> tensor<654x234xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<654x321xf8E4M3FNUZ>, tensor<234x321xf8E4M3FNUZ>) outs(%acc: tensor<654x234xf32>) -> tensor<654x234xf32>  return %result: tensor<654x234xf32>
}
...
func.func @matmul_457x160xf8E4M3FNUZ_times_512x160xf8E4M3FNUZ_into_457x512xf32(%lhs: tensor<457x160xf32>, %rhs: tensor<512x160xf32>) -> tensor<457x512xf32> {
  ...
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<457x160xf8E4M3FNUZ>, tensor<512x160xf8E4M3FNUZ>) outs(%acc: tensor<457x512xf32>) -> tensor<457x512xf32>  return %result: tensor<457x512xf32>
}
...
func.func @matmul_512x330xf8E4M3FNUZ_times_512x330xf8E4M3FNUZ_into_512x512xf32(%lhs: tensor<512x330xf32>, %rhs: tensor<512x330xf32>) -> tensor<512x512xf32> {
  ...
  %rhs_casted = arith.truncf %rhs: tensor<512x330xf32> to tensor<512x330xf8E4M3FNUZ>
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<512x330xf8E4M3FNUZ>, tensor<512x330xf8E4M3FNUZ>) outs(%acc: tensor<512x512xf32>) -> tensor<512x512xf32>  return %result: tensor<512x512xf32>
}
...
func.func @matmul_1000x1000xf8E4M3FNUZ_times_1x1000xf8E4M3FNUZ_into_1000x1xf32(%lhs: tensor<1000x1000xf32>, %rhs: tensor<1x1000xf32>) -> tensor<1000x1xf32> {
  ...
  %lhs_casted = arith.truncf %lhs: tensor<1000x1000xf32> to tensor<1000x1000xf8E4M3FNUZ>
  %rhs_casted = arith.truncf %rhs: tensor<1x1000xf32> to tensor<1x1000xf8E4M3FNUZ>
  %result = linalg.matmul_transpose_b ins(%lhs_casted, %rhs_casted: tensor<1000x1000xf8E4M3FNUZ>, tensor<1x1000xf8E4M3FNUZ>) outs(%acc: tensor<1000x1xf32>) -> tensor<1000x1xf32>  return %result: tensor<1000x1xf32>
}

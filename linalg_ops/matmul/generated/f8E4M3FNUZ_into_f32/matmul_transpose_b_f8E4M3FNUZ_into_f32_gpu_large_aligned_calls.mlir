...
func.func @matmul_accumulate_512x128xf8E4M3FNUZ_times_512x128xf8E4M3FNUZ_into_512x512xf32_512_128_512_acc_0() attributes {
...
func.func @matmul_512x128xf8E4M3FNUZ_times_512x128xf8E4M3FNUZ_into_512x512xf32_512_128_512_1() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device

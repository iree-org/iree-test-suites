...
func.func private @module.matmul_accumulate_123x456xf16_times_789x456xf16_into_123x789xf32(%lhs: !hal.buffer_view, %rhs: !hal.buffer_view, %acc: !hal.buffer_view) -> !hal.buffer_view
...
func.func @matmul_accumulate_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_123_456_789_acc_12() attributes {
...
func.func @matmul_accumulate_123x456xf16_times_789x456xf16_into_123x789xf32_123_456_789_acc_13() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 123x456x789"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
  ...
  %acc_copy = call @matmul_test.generate_random_matrix(%device, %acc_copy_dim0, %acc_copy_dim1, %acc_copy_element_type, %acc_copy_seed) : (!hal.device, i64, i64, i32, i32) -> !hal.buffer_view
  %result = call @module.matmul_accumulate_123x456xf16_times_789x456xf16_into_123x789xf32(%lhs, %rhs, %acc_copy) : (!hal.buffer_view, !hal.buffer_view, !hal.buffer_view) -> !hal.buffer_view
  %m = arith.constant 123 : i64
  %k = arith.constant 456 : i64
  %n = arith.constant 789 : i64
  %transpose_rhs = arith.constant 1 : i32
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_457_330_512_14() attributes {
...
func.func @matmul_457x330xf16_times_512x330xf16_into_457x512xf32_457_330_512_15() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 457x330x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_457_330_514_16() attributes {
...
func.func @matmul_457x330xf16_times_514x330xf16_into_457x514xf32_457_330_514_17() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 457x330x514"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_438_330_514_18() attributes {
...
func.func @matmul_438x330xf16_times_514x330xf16_into_438x514xf32_438_330_514_19() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 438x330x514"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_540_332_516_20() attributes {
...
func.func @matmul_540x332xf16_times_516x332xf16_into_540x516xf32_540_332_516_21() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 540x332x516"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_654_321_234_22() attributes {
...
func.func @matmul_654x321xf16_times_234x321xf16_into_654x234xf32_654_321_234_23() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 654x321x234"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_457_160_512_24() attributes {
...
func.func @matmul_457x160xf16_times_512x160xf16_into_457x512xf32_457_160_512_25() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 457x160x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_512_330_512_26() attributes {
...
func.func @matmul_512x330xf16_times_512x330xf16_into_512x512xf32_512_330_512_27() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x330x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_accumulate_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_1_1000_1000_acc_28() attributes {
...
func.func @matmul_accumulate_1x1000xf16_times_1000x1000xf16_into_1x1000xf32_1_1000_1000_acc_29() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 1x1000x1000"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_accumulate_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_1000_1000_1_acc_30() attributes {
...
func.func @matmul_accumulate_1000x1000xf16_times_1x1000xf16_into_1000x1xf32_1000_1000_1_acc_31() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 1000x1000x1"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_DYNxDYNxf16_times_DYNxDYNxf16_into_DYNxDYNxf32_1000_1000_1_32() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 1000x1000x1"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
func.func @matmul_1000x1000xf16_times_1x1000xf16_into_1000x1xf32_1000_1000_1_33() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 1000x1000x1"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device

...
func.func private @module.attention_2_DYN_16_64_DYN_dtype_f16_f16_f16_f16(%query: !hal.buffer_view, %key: !hal.buffer_view, %value: !hal.buffer_view, %scale: f32) -> !hal.buffer_view
func.func private @module.attention_2_256_16_64_32_dtype_f16_f16_f16_f16(%query: !hal.buffer_view, %key: !hal.buffer_view, %value: !hal.buffer_view, %scale: f32) -> !hal.buffer_view

func.func @attention_2_DYN_16_64_DYN_dtype_f16_f16_f16_f16_2_256_16_64_32_64_1.0_0() attributes {
  iree.reflection = {description = "Attention shape (BATCHxMxNxK1xK2): 2x256x16x64x32x1.0"}
} {
  ...
  %result = call @module.attention_2_DYN_16_64_DYN_dtype_f16_f16_f16_f16(%query, %key, %value, %scale) : (!hal.buffer_view, !hal.buffer_view, !hal.buffer_view, f32) -> !hal.buffer_view
...
func.func @attention_2_256_16_64_32_dtype_f16_f16_f16_f16_2_256_16_64_32_64_1.0_1() attributes {
  iree.reflection = {description = "Attention shape (BATCHxMxNxK1xK2): 2x256x16x64x32x1.0"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
  ...
  %value = call @attention_test.generate_random_tensor(%device, %value_dim0, %value_dim1, %value_dim2, %value_element_type, %value_seed) : (!hal.device, i64, i64, i64, i32, i32) -> !hal.buffer_view
  %scale = arith.constant 1.0 : f32
  %result = call @module.attention_2_256_16_64_32_dtype_f16_f16_f16_f16(%query, %key, %value, %scale) : (!hal.buffer_view, !hal.buffer_view, !hal.buffer_view, f32) -> !hal.buffer_view
  %batch = arith.constant 2 : i64
  %m = arith.constant 256 : i64
  %n = arith.constant 16 : i64
  %k1 = arith.constant 64 : i64

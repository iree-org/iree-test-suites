func.func @attention_2_DYN_64_128_DYN_dtype_f16_f16_f16_f16(%query: tensor<2x?x128xf16>, %key: tensor<2x?x128xf16>, %value: tensor<2x?x64xf16>, %scale: f32) -> tensor<2x?x64xf16> {
  ...
  %value_mixed = flow.tensor.tie_shape %value : tensor<2x?x64xf16>{%k2}
  %result0 = tensor.empty(%m): tensor<2x?x64xf16>
...
}  ins(%query_mixed, %key_mixed, %value_mixed, %scale_f16: tensor<2x?x128xf16>, tensor<2x?x128xf16>, tensor<2x?x64xf16>, f16)
      outs(%result0: tensor<2x?x64xf16>) {
   ^bb0(%score: f32):
   iree_linalg_ext.yield %score : f32
 } -> tensor<2x?x64xf16>
 return %result1: tensor<2x?x64xf16>
}
func.func @attention_2_1024_64_128_128_dtype_f16_f16_f16_f16(%query: tensor<2x1024x128xf16>, %key: tensor<2x128x128xf16>, %value: tensor<2x128x64xf16>, %scale: f32) -> tensor<2x1024x64xf16> {
